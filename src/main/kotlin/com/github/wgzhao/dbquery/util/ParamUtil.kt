...
object ParamUtil {
    ...
    fun sortedParams(params: MutableMap<String?, String?>): String? {
    ...
    fun lowercaseParams(params: MutableMap<String?, String?>): MutableMap<String?, String?> {
        ...
        for (entry in params.entries) {
            lowerParams.put(entry.key!!.lowercase(Locale.getDefault()), entry.value)
        }
        return lowerParams
    }
    ...
    fun getControlParams(allParams: MutableMap<String?, String?>): MutableMap<String?, String?> {
        return allParams.keys
            .stream()
            .filter { key: String? -> key!!.startsWith("_") }
            .collect(
